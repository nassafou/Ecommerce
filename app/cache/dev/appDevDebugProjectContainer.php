...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ecommerce', 'user' => 'root', 'password' => 'Pa$$w0rd1', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_502a7f47befd01029ee485cb3cf40c23');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_502a7f47befd01029ee485cb3cf40c23');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_502a7f47befd01029ee485cb3cf40c23');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Ecommerce/EcommerceBundle/Entity'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Entity'), 2 => ($this->targetDirs[3].'/src/Utilisateurs/UtilisateursBundle/Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Ecommerce\\EcommerceBundle\\Entity');
        $f->addDriver($e, 'FOS\\UserBundle\\Entity');
        $f->addDriver($e, 'Utilisateurs\\UtilisateursBundle\\Entity');
        ...
        $g->setEntityNamespaces(array('EcommerceBundle' => 'Ecommerce\\EcommerceBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'd4c9e0222a59d1c5d39ec5f0c3a108ea6');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'secured_area', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '_demo_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Pages/PagesBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Utilisateurs/UtilisateursBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('telephone', '06 52 54 77 91');
        $instance->addGlobal('fax', '02 35 00 00 00');
        $instance->addGlobal('adresse', '23 Avenue Arnold Netter 75012');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d4c9e0222a59d1c5d39ec5f0c3a108ea6');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'Pa$$w0rd1',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'd4c9e0222a59d1c5d39ec5f0c3a108ea6',
            ...
            'kernel.secret' => 'd4c9e0222a59d1c5d39ec5f0c3a108ea6',
