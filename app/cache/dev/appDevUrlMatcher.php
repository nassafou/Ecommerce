...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/page') && preg_match('#^/page/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'page')), array (  '_controller' => 'Pages\\PagesBundle\\Controller\\PagesController::pagesAction',));
        }
        ...
        if (0 === strpos($pathinfo, '/catego')) {
            // ecom_categories
            if ($pathinfo === '/categoiries') {
                return array (  '_controller' => 'Ecommerce\\EcommerceBundle\\Controller\\CategoriesController::menuAction',  '_route' => 'ecom_categories',);
            }

            // categorieProduits
            if (0 === strpos($pathinfo, '/categories') && preg_match('#^/categories/(?P<categorie>[^/]++)$#s', $pathinfo, $matches)) {
