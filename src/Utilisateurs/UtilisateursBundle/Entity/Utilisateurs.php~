...
class Utilisateurs extends BaseUser
{
     ...
     * @return Utilisateurs
     */
    public function addAdresse(\Ecommerce\EcommerceBundle\Entity\UtilisateursAdresses $adresses)
    {
     ...
     * @param \Ecommerce\EcommerceBundle\Entity\UtilisateursAdresses $adresses
     */
    public function removeAdresse(\Ecommerce\EcommerceBundle\Entity\UtilisateursAdresses $adresses)
    {
